...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    if (r || o || a) {
        ...
        document.head.querySelector('script[src*="' + n + '"]') || ((s = document.createElement("script")).type = "text/javascript", s.src = "https://static.tildacdn.com/js/" + n + ".min.js", s.onerror = function() {
        ...
        if (i && (h || g && v)) m.type.push("req");
            ...
            switch (s) {
                ...
                case "date":
                    ...
                    } [n.getAttribute("data-tilda-dateformat")] || /^[0-9]{1,4}[\-\.\/][0-9]{1,2}[\-\.\/][0-9]{1,4}$/gi) && m.type.push("date");
                    break;
                case "time":
    ...
    if ("y" === w) {
        ...
        A && window.tcart.prodamount < window.tcart_minorder && ((m = {
            obj: {},
            type: []
        }).type.push("minorder"), r.push(m)), F && window.tcart.total < window.tcart_mincntorder && ((m = {
            obj: {},
            type: []
    ...
    for (var u = 0; u < e.length; u++)
        if (e[u] && e[u].obj) {
            ...
            var m = e[u].obj;
            m instanceof Element || (m = m[0]), m && (a = m.closest(o)), a && (s = a.querySelectorAll(".t-input-error"), t_addClass(a, "js-error-control-box"), s.length && (n = !0));
            for (var p = 0; p < e[u].type.length; p++) {
                var f = e[u].type[p],
                    _ = t_forms__getMsg(f);
                l = "", (i = t.querySelector(".js-rule-error-" + f)) ? i.textContent && i.innerText || !_ || -1 !== d.indexOf(_) ? (l = i.textContent || i.innerText, -1 === d.indexOf(_) && (d = d + '<p class="t-form__errorbox-item">' + l + "</p>")) : d = d + '<p class="t-form__errorbox-item">' + _ + "</p>" : _ && -1 === d.indexOf(_) && (d = d + '<p class="t-form__errorbox-item">' + _ + "</p>"), n && (!l && t_forms__getMsg(f + "field") ? l = t_forms__getMsg(f + "field") : _ && (l = _), l && a && (s = a.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(s, (function(t) {
                    t.innerHTML = l, t_fadeIn(t)
                }))))
            }
        } if (d) {
        c.querySelector(".t-form__errorbox-text").innerHTML = d;
        var y = c.querySelectorAll(".t-form__errorbox-item");
    ...
    function w(t) {
        if ("INPUT" === ((t = t || window.event).target || t.srcElement).tagName) {
            var e = h.querySelectorAll("form .t-input-error");
            t_fadeOut(c), Array.prototype.forEach.call(e, (function(t) {
    ...
    if (window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = window.setTimeout((function() {
        ...
        var h = t.closest(".r"),
            g = "focus";
        document.addEventListener || (g = "focusin"), t_removeEventListener(h, g, w), t_addEventListener(h, g, w, !0), t_removeEventListener(h, "change", w), t_addEventListener(h, "change", w, !0)
    }
    ...
    r || (r = ".blockinput");
    for (var o = "", a = !1, n = "", i = "", s = "", l = 0; l < e.length; l++)
        if (e[l] && e[l].obj) {
            if (0 === l && "none" === e[l].obj) {
            ...
            var c = e[l].obj;
            c instanceof Element || (c = c[0]), c && (o = c.closest(r)), o && (i = o.querySelectorAll(".t-input-error"), t_addClass(o, "js-error-control-box"), i.length > 0 && (a = !0));
            for (d = 0; d < e[l].type.length; d++) {
                var u = e[l].type[d];
                if (s = "", (n = t.querySelectorAll(".js-rule-error-" + u)).length)
    ...
    if (inputItsGood || form.insertAdjacentHTML("beforeend", '<div style="position: absolute; left: -5000px; bottom: 0; display: none;"><input type="text" name="form-spec-comments" value="Its good" class="js-form-spec-comments" tabindex="-1" /></div>'), 2 === formType || !formType && formKey) {
      ...
      console.log(1);
        ...
        var formUrl = "https://"+"hello.ru"+ "/procces/",
            dataForm = [],
            arrFilter = [];
        ...
        return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function() {
            if (4 === xhr.readyState)
                if (xhr.status >= 200 && xhr.status < 400) {
                    ...
                    if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", d = xhr.responseText)
                        if ("{" == d.substring(0, 1)) {
                            var o = JSON.parse(d);
                            if ("object" == typeof o)
                                if (o && o.message && "OK" !== o.message) t.innerHTML = o.message;
                                else if (o && o.error) {
                                var a = (l = t_forms__getErrorContainers(form, "Unknown error. Please, try again later.")).errorBoxes,
                                    n = l.allError;
                        ...
                        } else t.innerHTML = d, t_parseScripts(t, "");
                    var i = "/tilda/" + formId + "/submitted/",
                        s = "Send data from form " + formId;
                    window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics ? window.Tilda.sendEventToStatistics(i, s, "", 0) : "undefined" != typeof ga && "tilda" !== window.mainTracker ? ga("send", {
                        hitType: "pageview",
                        page: i,
                        title: s
                    ...
                    a = (l = t_forms__getErrorContainers(form, "")).errorBoxes, n = l.allError;
                    var l, d = xhr.responseText;
                    Array.prototype.forEach.call(n, (function(t) {
                        d ? t.innerHTML = d + ". Please, try again later. [" + xhr.status + "]" : xhr.statusText ? t.innerHTML = "Error [" + xhr.statusText + "]. Please, try again later. [" + xhr.status + "]" : t.innerHTML = "Unknown error. Please, try again later. [" + xhr.status + "]", t.style.display = "block"
                    })), Array.prototype.forEach.call(a, (function(t) {
                        t.style.display = "block"
                    })), t_addClass(form, "js-send-form-error"), t_triggerEvent(form, "tildaform:aftererror")
                }
    ...
    if (r) {
        ...
        if (o) {
            ...
            if (r.tildaSendingStatus && (i = r.tildaSendingStatus), !(i && i >= 1 || t_hasClass(r, "t706__submit_disable"))) {
                ...
                var s = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
                    l = parseInt(o.getAttribute("data-formactiontype"));
                if (!o.querySelectorAll(".js-formaction-services").length && 1 !== l && !s) {
                    var d = t_forms__getErrorContainers(o, ""),
                        c = d.errorBoxes,
                        u = d.allError;
                ...
                if (o.querySelector(".g-recaptcha") && grecaptcha) {
                    ...
                    var m = o.tildaCaptchaClientId;
                    if (m) grecaptcha.reset(m);
                    else {
                        var p = {
                            size: "invisible",
                        ...
                        m = grecaptcha.render(a + "recaptcha", p), o.tildaCaptchaClientId = m
                    }
                    grecaptcha.execute(m)
                } else window.tildaForm.send(o, r, l, s)
            }
        }
    }
}
...
function t_forms__onSuccess(t) {
    ...
    var e, r = t.closest(".r"),
        ...
        i = parseInt(n.paddingTop) || 0,
        s = parseInt(n.paddingBottom) || 0,
        l = a.clientHeight - (i + s) + (a.getBoundingClientRect().top + window.pageYOffset),
        d = t.querySelector(".t-form__successbox").getBoundingClientRect().top + window.pageYOffset,
        c = window.innerHeight,
        u = document.body,
        m = document.documentElement,
        p = Math.max(u.scrollHeight, u.offsetHeight, m.clientHeight, m.scrollHeight, m.offsetHeight);
    if (121 == o) {
        var f = t.getAttribute("data-success-callback");
        f && (o = f.split("_onSuccess")[0].replace("t", ""))
    }
    var _ = "t" + o + "__inputsbox_hidden",
        y = [702, 708, 862, 945, 1014],
        w = !0;
    e = window.innerWidth > 960 ? d - 200 : d - 100;
    var h = document.querySelector(".t-tildalabel");
    if (d > window.scrollY || p - l < c - 100) a.classList.add(_), c > p && h && setTimeout((function() {
        t_fadeOut(h)
    }), 300);
    else {
        for (var g = 0; g < y.length; g++)
            if (y[g] == o) {
                w = !1;
                break
            } w && t_forms__scrollBeginForm(e), setTimeout((function() {
            a.classList.add(_)
        }), 400)
    }
    var v = t.getAttribute("data-success-url");
    if (v && setTimeout((function() {
            window.location.href = v
        }), 500), 835 == o || 862 == o) {
        var b = r.querySelector(".t835__btn_prev");
...
function t_forms__scrollBeginForm(t) {
    ...
    document.body.setAttribute("data-scrollable", "true"),
        function t() {
            o += 16, window.scrollTo(0, function(t) {
                return (t /= 200) < 1 ? r / 2 * t * t * t + e : r / 2 * ((t -= 2) * t * t + 2) + e
            }(o)), o < 400 ? setTimeout(t, 16) : document.body.removeAttribute("data-scrollable")
        }()
}
